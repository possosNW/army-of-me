...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/army-of-me
```

A live public deployment of this template is available at [https://army-of-me.templates.workers.dev](https://army-of-me.templates.workers.dev)
